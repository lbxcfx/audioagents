  ...
  return (
    <main className="workspace-home">
      ...
      <section className="workspace-products" aria-label="产品功能">
        <article className="workspace-product service-product">
          <div className="workspace-product-number">01</div>
          ...
          <a href="/app/inbound/agents">进入智能客服 <b>→</b></a>
        </article>
        <article className="workspace-product outbound-product">
          <div className="workspace-product-number">02</div>
          <div className="workspace-product-copy">
            <span>智能外呼</span>
          ...
          <a href="/app/dashboard">进入智能外呼 <b>→</b></a>
        </article>
      </section>
