    ...
    await perform(async () => {
      await request(`/api/platform/projects/${projectId}/embed-configs`, {
        ...
        body: JSON.stringify({
          ...
          capabilities: { audio: data.audio === "on", text: data.text === "on", video: false },
          enabled: data.enabled === "on",
        }),
      });
      form.reset();
